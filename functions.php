...
if ( ! function_exists( 'simplepress_setup' ) ) :
	...
	function simplepress_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'simplepress' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'simplepress_custom_background_args', array(
...
function simplepress_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'simplepress_content_width', 640 );
}
...
function simplepress_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'simplepress' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'simplepress' ),
		'before_widget' => '<section id="%1$s" class="widget widget-container mb-3 %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2><hr>',
	) );
	/**
	 * Footer Widget / Sidebars
	 * @since 0.1
	 */
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 1', 'simplepress' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add widgets here.', 'simplepress' ),
		'before_widget' => '<section id="%1$s" class="widget footer-widget-content %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title h6">',
		'after_title'   => '</h2><hr>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 2', 'simplepress' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add widgets here.', 'simplepress' ),
		'before_widget' => '<section id="%1$s" class="widget footer-widget-content %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 3', 'simplepress' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add widgets here.', 'simplepress' ),
		'before_widget' => '<section id="%1$s" class="widget footer-widget-content %2$s">',
		'after_widget'  => '</section>',
...
function simplepress_scripts() {
	...
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), '1.4', true );

	wp_enqueue_script( 'simplepress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
